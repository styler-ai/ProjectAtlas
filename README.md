...
| [Native release](https://github.com/styler-ai/ProjectAtlas/releases/tag/v0.4.0) | Install a verified prebuilt binary without Rust/Cargo. |
| Cargo | `cargo install --git https://github.com/styler-ai/ProjectAtlas --tag v0.4.0 projectatlas-cli --locked` |
