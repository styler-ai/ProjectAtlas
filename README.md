...
ProjectAtlas [v0.5.0-rc1](https://github.com/styler-ai/ProjectAtlas/releases/tag/v0.5.0-rc1) is prepared to be published as a prerelease and does not replace the preceding stable GitHub Latest release. See the [RC1 release notes](docs/v0.5.0-rc1-release-notes.md) for its scope and compatibility boundaries.
