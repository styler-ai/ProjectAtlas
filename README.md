...
<p align="center">
  ...
  <a href="https://github.com/styler-ai/ProjectAtlas/releases/tag/v0.3.10"><img alt="release" src="https://img.shields.io/badge/release-v0.3.10-blue"></a>
...
```bash
codex plugin marketplace add styler-ai/ProjectAtlas --ref v0.3.10
...
```bash
cargo install --git https://github.com/styler-ai/ProjectAtlas --tag v0.3.10 projectatlas-cli --locked
```
...
`v0.3.10` ships through the full release matrix:
