...
flowchart LR
    ...
    CandidateObject --> CandidateClean["No tracked, staged, or non-ignored untracked changes; no hidden flags; linked docs are regular tracked Markdown files in candidate tree"]
