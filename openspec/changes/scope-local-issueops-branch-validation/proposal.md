...
- Route pre-push validation from its pushed remote refs: any `refs/heads/main` update remains global, while only all-non-main branch updates use candidate mode; release checks remain global.
