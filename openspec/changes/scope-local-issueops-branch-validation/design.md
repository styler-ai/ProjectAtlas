...
- **Push-target or shell ownership extraction drifts from the contract** -> cover main-from-feature, ordinary candidate, mixed refs, malformed records, zero, one, duplicate-same, and multiple-owner inputs in the existing workflow-contract tests.
