...
- Add PDF and DOCX extraction only, using pinned `pdf-extract` 0.12.0, `quick-xml` 0.42.0, and `zip` 0.6.6 under strict admission/resource/provenance limits and sparse exact evidence.
