...
- OpenSpec/IssueOps mapping, candidate-versus-published readiness, native GitHub hierarchy and dependency graph, affected-contract CI, one Dependabot campaign per release, version-matched guidance, issue-specific Mermaid documentation, and final hosted release state.
