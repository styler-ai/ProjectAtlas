...
- **WHEN** a candidate forwarder has the public marker, exact generated body, and valid runtime target but its independent installer provenance is missing, mismatched, reparse-linked, or hard-linked
...
- **THEN** publication never force-replaces the destination, and a prior owned forwarder plus provenance remains usable until a fully verified replacement is published
