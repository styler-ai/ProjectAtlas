...
- **AND** live page-number and date blocks and footnote/endnote reference markers requiring evaluation return typed unsupported input without reading additional parts; deleted, moved-from, and unselected blocks remain excluded
