...
- Remove task-specific test identifiers, verification plans, evidence ledgers, task commit digests, exact-head task receipts, rendered evidence workflows, task-level run/permalink requirements, and issue-sealing machinery.
