...
- [ ] 5.1 After tasks 1.1 through 4.4 are true, check the completed tasks and this reconciliation task, mirror #311 exactly, rerun cheap IssueOps, OpenSpec, review, topology, and policy gates, and reuse the clean optional-parser handoff unless its behavior-relevant inputs changed.
