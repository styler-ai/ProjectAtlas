...
- [x] 4.4 Update durable graph, database, upgrade, agent-integration, release, privacy, and failure guidance; resolve or disposition every live review/automated finding and verify the exact packaged RC2 behavior without displacing v0.4.4 Latest.
