...
Ready for implementation under issue #568 and release owner #492. The intended implementation is limited to Cargo.toml and Cargo.lock plus the owning OpenSpec and issue-map metadata. Existing MCP and parser-worker tests supply compatibility proof.
