...
- [ ] 3.3 Remove redundant full-timeout and duplicate valid-runtime process probes from the owning Windows E2E while retaining direct output-limit, true-timeout, cleanup, compatibility, and 30-second aggregate-watchdog proof; rerun the ordinary hosted Windows gate without retry or timeout inflation.
