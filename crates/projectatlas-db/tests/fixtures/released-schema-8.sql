-- Historical physical schema emitted by ProjectAtlas 0.3.26.
-- Keep this fixture independent from the current schema DDL so migration tests
-- detect accidental incompatibility with databases created by that release.
